...
BunnyDefender.Game.prototype = {
    ...
    updateSeconds: function() {
        if (!this.gameover){
            this.secondsElapsed++;
            this.displayTimer.setText('Time ' + this.secondsElapsed);
        }
    },
    buildWorld: function(){
        ...
        this.displayTimer = this.add.bitmapText(10, 30, 'eightbitwonder', 'Time ' + this.secondsElapsed, 20);
        this.timer.start();
    },
    ...
    buildSpaceRocks: function() {
        ...
        for(var i=0; i<this.totalSpacerocks; i++) {
            ...
            r.checkWorldBounds = true; r.events.onOutOfBounds.add(this.resetRock, this);
        }
